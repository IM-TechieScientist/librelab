...
static char const UDP_REGISTER_REQUEST[] = "LIBRELAB_UDP_REGISTER";
...
static void udp_task(void *arg)
{
    ...
    while (true) {
        ...
        if (control_len > 0) {
            if (control_len == sizeof(UDP_REGISTER_REQUEST) - 1 &&
                memcmp(control_buffer, UDP_REGISTER_REQUEST,
                       sizeof(UDP_REGISTER_REQUEST) - 1) == 0) {
