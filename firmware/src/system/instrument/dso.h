/**
 * @file dso.h
 * @brief Digital Storage Oscilloscope interface for LibreLab Pico firmware
 *
 * The DSO uses the RP2350 internal ADC, supports one channel at a time, and
 * exposes trigger/capture helpers to the SCPI application layer.
 *
 * @author LibreLab Team
 * @date 2025-09-29
 */

#ifndef LIBRELAB_DSO_H
#define LIBRELAB_DSO_H
