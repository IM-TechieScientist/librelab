/**
 * @file dso.c
 * @brief Digital Storage Oscilloscope implementation for LibreLab Pico firmware
 *
 * This file implements the LibreLab DSO instrument boundary and delegates
 * low-level RP2350 ADC capture to the ADC frontend interface.
 *
