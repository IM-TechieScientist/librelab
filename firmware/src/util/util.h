/**
 * @file util.h
 * @brief Utility types and functions for LibreLab Pico firmware
 *
 * This library provides utility types and functions for the LibreLab firmware.
 */

#ifndef LIBRELAB_UTIL_H
#define LIBRELAB_UTIL_H
